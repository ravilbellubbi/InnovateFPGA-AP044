...
workspace_name = "Majorproject" # PLACEHOLDER
subscription_id = "2182a85f-cbea-4341-aa4c-ef8c3e77f69c" # PLACEHOLDER
resource_group = "fpga-proj" # PLACEHOLDER
experiment_name = "Majorproj1" # PLACEHOLDER
iteration = "21"  # PLACEHOLDER
run_id = "AutoML_2bd69015-ea31-4ef1-931f-c8c82d395948_21"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'bhavanabr212','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':[],'is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':3,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'Majorproj1','path':'./sample_projects/Majorproj1','primary_metric':'accuracy','region':'centralindia','resource_group':'fpga-proj','subscription_id':'2182a85f-cbea-4341-aa4c-ef8c3e77f69c','task_type':'classification','validation_size':0.25,'test_size':0.1,'vm_type':'STANDARD_DS11_V2','workspace_name':'Majorproject','label_column_name':'Fire','positive_label':None,'save_mlflow':True,'enable_batch_run':True} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"XGBoostClassifier\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"booster\": \"gbtree\", \"colsample_bytree\": 0.5, \"eta\": 0.2, \"gamma\": 0, \"max_depth\": 7, \"max_leaves\": 7, \"n_estimators\": 25, \"objective\": \"reg:logistic\", \"reg_alpha\": 0, \"reg_lambda\": 0.20833333333333334, \"subsample\": 1, \"tree_method\": \"auto\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"e478544eb8734c07a1943f5bdf4e6605be6943df\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, XGBoostClassifier }\"}" # PLACEHOLDER
pipeline_id = "e478544eb8734c07a1943f5bdf4e6605be6943df" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"c8acdb8f-0266-4ce8-9d97-2b54f2670efa\"}}" # PLACEHOLDER
