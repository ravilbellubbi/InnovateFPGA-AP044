...
run_id = "AutoML_dd20044e-3341-4ed9-8637-095c1a89f802_0"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'whitelist_models':None,'compute_target':'bhavanabr212','enable_dnn':True,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':1440,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':1440,'max_concurrent_iterations':3,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'Majorproj1','path':'./sample_projects/Majorproj1','primary_metric':'AUC_weighted','region':'centralindia','resource_group':'fpga-proj','subscription_id':'2182a85f-cbea-4341-aa4c-ef8c3e77f69c','task_type':'classification','validation_size':0.25,'test_size':0.1,'vm_type':'STANDARD_DS11_V2','workspace_name':'Majorproject','label_column_name':'Fire','positive_label':None,'save_mlflow':True,'enable_batch_run':True} # PLACEHOLDER
pipeline_spec = "{\"objects\":[{\"spec_class\":\"preproc\",\"class_name\":\"MaxAbsScaler\",\"module\":\"sklearn.preprocessing\",\"param_args\":[],\"param_kwargs\":{},\"prepared_kwargs\":{}},{\"spec_class\":\"sklearn\",\"class_name\":\"LightGBMClassifier\",\"module\":\"automl.client.core.common.model_wrappers\",\"param_args\":[],\"param_kwargs\":{\"min_data_in_leaf\":20},\"prepared_kwargs\":{}}],\"pipeline_id\":\"5dfac790c5c209f98a1da2dc1c7fb76f0397324f\",\"module\":\"sklearn.pipeline\",\"class_name\":\"Pipeline\"}" # PLACEHOLDER
pipeline_id = "5dfac790c5c209f98a1da2dc1c7fb76f0397324f" # PLACEHOLDER
